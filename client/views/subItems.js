...
Template.ptjs.helpers({
	items: function () {
		return [
			{
				title: '了解四大平台',
				subtitle: '平台介绍',
				img: '../image/subitems/ptjs1.png',
				url: '',
				color: 'c0'
			},
			{
